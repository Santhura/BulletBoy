...
public class Room {
    ...
    public int roomHeight;                  // How many tiles tall the room is.
    ...
    public void SetupRoom(IntRange widthRange, IntRange heightRange, int columns, int rows)
    {
        ...
        // Set the x and y coordinates so the room is roughtly in the middle of the board.
    ...
    public void SetupRoom(IntRange widthRange, IntRange heightRange, int columns, int rows, Corridor corridor)
    {
        ...
        switch (corridor.direction)
        {
            ...
            case Direction.North :
                ...
                // This must be clamped to ensure that the room doesn't fo off the board.
            ...
            case Direction.South:
                ...
                xPos = Random.Range(corridor.EndPositionX - roomWidth + 1, corridor.EndPositionX);
                xPos = Mathf.Clamp(xPos, 0, rows - roomHeight);
                break;
            case Direction.West:
