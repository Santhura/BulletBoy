...
public class Corridor {
    ...
    public Direction direction;         // Which direction th ecorridor is heading from it's room.
    ...
    public void SetupCorridor (Room room, IntRange length, IntRange roomWidth, IntRange roomHeight, int columns, int rows, bool firstCorridor)
    {
        ...
        switch (direction)
        {
            ...
            case Direction.East:
                ...
                maxLength = columns - startXPos - roomHeight.m_Min;
                break;
