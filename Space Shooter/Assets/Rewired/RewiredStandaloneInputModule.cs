...
namespace Rewired.Integrations.UnityUI {
    ...
    public class RewiredStandaloneInputModule : PointerInputModule {
        ...
        private bool AllowMoveEventProcessing(float time) {
            ...
            for(int i = 0; i < players.Length; i++) {
                ...
                allow |= player.GetButtonDown(m_HorizontalAxis);
                allow |= player.GetButtonDown(m_VerticalAxis);
        ...
        private Vector2 GetRawMoveVector() {
            ...
            for(int i = 0; i < players.Length; i++) {
                ...
                horizButton |= player.GetButtonDown(m_HorizontalAxis);
                vertButton |= player.GetButtonDown(m_VerticalAxis);
            }
